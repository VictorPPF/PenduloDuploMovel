...
* [Código que **simula** o movimento em 3D do Pêndulo usando uma biblioteca que suporta animações (Vpython).](https://github.com/VictorPPF/PenduloDuploMovel/tree/main/README.md#c%C3%B3digo-que-simula-o-movimento-do-p%C3%AAndulo)
